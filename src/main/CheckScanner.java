...
//	    ArrayList<Piece> pieceList = board.pieceList;
//
//	    // Check each piece for legal moves
//	    for (Piece piece : pieceList) {
//	        ArrayList<Move> legalMoves = piece.getLegalMoves(board);
...
//	                // The king is not in check after the move, so it's not checkmate
//	                board.undoMove();
//	                return false;
//	            }
//
...
//	}
	...
	private boolean checkKnight(Piece p, Piece k, int col, int row) { // k means king
