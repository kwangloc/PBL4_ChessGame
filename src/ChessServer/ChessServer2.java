...
//		new ChessServer2();
//	}
//	public ChessServer2(serverManagerForm serverManagerForm) {
...
//	}
	...
	public void startServer() {
		try {
			...
			System.out.println("server run 6666");
			while(true) {
				try {
...
//					} 
					...
					System.out.println("loi 60" + e1.getMessage());
					break;
				}
			}
		} catch (Exception e) {
			System.out.println("loi 64" + e.getMessage());
		}
	}
...
//				playerList.get(i).interrupt();
			...
			serverManagerForm.updateServer2(playerList.size()+"");
		} catch (IOException e) {
			System.out.println(e.getMessage());
			e.printStackTrace();
		}
...
//				System.out.println(j + ":" + server.playerList.get(j).soc.isClosed());
	...
	public int[] chessEngine(String listMoves) {
		...
		try {
			...
			String goCommand = "go movetime 3000\n";
...
//						DataOutputStream dos = new DataOutputStream(server.playerList.get(0).soc.getOutputStream());
				...
				System.out.println("loi 388" + e.getMessage());
